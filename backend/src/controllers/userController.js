...
export default class UserController {
    ...
    async login(req, res) {
        ...
        if (!user) {
            ...
            return res.json({ success: true, message: "Login successful", user_id: user.id, user_name: user.fullname, user_email: user.email, user_type: user.type, user_status: user.status });
