                ...
                <div className="col-md-6 col-sm-12">
                    <div className="m-3 p-3">
                        <form className="p-4" action="#" method="post">
                            ...
                            <h3>Bid on Your Favorite</h3><br />
                            <h6>Enter Your Details Below</h6>
                            <div className="form-group m-1">
                                <input type="text" className="form-control mt-2 p-3 h-4 border-dark text-success " id="fullName" name="fullName" required placeholder="Full Name" />
                            </div>
                            <div className="form-group m-1">
                                <input type="email" className="form-control mt-2 p-3 h-4 border-dark text-success " id="email" name="email" required placeholder="Email Address" />
                            </div>
                            ...
                            <div className="d-flex justify-content-center">
                                Already have an account? &nbsp; <a href="#" className="text-decoration-none text-success"> <b> Login </b></a>
                            </div>
                        </form>
                    </div>
                </div>
